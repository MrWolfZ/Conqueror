# Conqueror recipe (Interactive Streaming Expert): propagate background context information (e.g. trace ID) across multiple commands, queries, events, and streams
