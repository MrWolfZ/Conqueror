...
internal sealed class HttpStreamingRequestTransportClient : IStreamingRequestTransportClient
{
    private readonly IConquerorContextAccessor conquerorContextAccessor;

    public HttpStreamingRequestTransportClient(ResolvedHttpClientOptions options, IConquerorContextAccessor conquerorContextAccessor)
    {
