...
{
    public override ImmutableArray<string> FixableDiagnosticIds => [C0001CommandHandlerWithPipelineConfigurationInterfaceHasConfigurationMethodAnalyzer.DiagnosticId];
