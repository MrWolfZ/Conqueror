...
file sealed class TestTransportMessageHandlerTypesInjector<TMessage, TResponse, TIHandler, THandler>
    : ITestTransportMessageHandlerTypesInjector
    where TMessage : class, ITestTransportMessage<TMessage, TResponse>
    where TIHandler : class, ITestTransportMessageHandler<TMessage, TResponse, TIHandler>
    where THandler : class, TIHandler
{
    public static readonly TestTransportMessageHandlerTypesInjector<TMessage, TResponse, TIHandler, THandler> Default =
        new();
