namespace Conqueror.SourceGenerators.Tests.Iterating.TestCases.WithUnrelatedAttributeWithIteratorSuffix;
...
public sealed class UnrelatedIteratorAttribute : Attribute;
