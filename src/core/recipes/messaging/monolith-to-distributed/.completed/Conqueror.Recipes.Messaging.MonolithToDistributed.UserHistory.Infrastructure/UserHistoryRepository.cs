namespace Conqueror.Recipes.Messaging.MonolithToDistributed.UserHistory.Infrastructure;

internal class UserHistoryRepository : IUserHistoryReadRepository, IUserHistoryWriteRepository
{
