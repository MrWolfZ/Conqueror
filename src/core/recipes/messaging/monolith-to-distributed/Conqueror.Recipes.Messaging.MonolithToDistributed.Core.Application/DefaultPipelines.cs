namespace Conqueror.Recipes.Messaging.MonolithToDistributed.Core.Application;
...
public static class DefaultPipelines
{
    public static IMessagePipeline<TMessage, TResponse> UseDefault<TMessage, TResponse>(this IMessagePipeline<TMessage, TResponse> pipeline)
        ...
        pipeline.UseLogging(o => o.LoggerCategoryFactory = message => message.GetType().FullName?.Replace("Conqueror.Recipes.Messaging.MonolithToDistributed.", "", StringComparison.Ordinal) ?? "");
}
