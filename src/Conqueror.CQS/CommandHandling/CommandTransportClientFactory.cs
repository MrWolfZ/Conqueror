...
internal sealed class CommandTransportClientFactory
{
    ...
    public Task<ICommandTransportClient> Create(Type commandType, Type responseType, IServiceProvider serviceProvider, ConquerorContext conquerorContext)
    {
        ...
        var transportBuilder = new CommandTransportClientBuilder(serviceProvider, conquerorContext, commandType, responseType);
