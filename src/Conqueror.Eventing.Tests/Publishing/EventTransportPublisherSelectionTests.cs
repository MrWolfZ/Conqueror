...
public sealed class EventTransportPublisherSelectionTests
{
    ...
    public void GivenEventWithMultipleCustomTransports_WhenNoPublisherForAnyTransportIsRegistered_ThrowsUnknownPublisherException()
    {
        ...
        Assert.That(() => observer.Handle(testEvent), Throws.InstanceOf<ConquerorUnknownEventTransportPublisherException>());
        Assert.That(() => dispatcher.DispatchEvent(testEvent), Throws.InstanceOf<ConquerorUnknownEventTransportPublisherException>());
    }
    ...
    private sealed class TestEventTransport2Publisher(TestObservations observations, Exception2? exceptionToThrow = null) : IConquerorEventTransportPublisher<TestEventTransport2Attribute>
    {
    ...
    private sealed class MultiTestEventTransportPublisher(TestObservations observations) : IConquerorEventTransportPublisher<TestEventTransportAttribute>,
