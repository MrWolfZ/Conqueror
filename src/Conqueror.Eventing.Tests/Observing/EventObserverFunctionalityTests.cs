...
public sealed class EventObserverFunctionalityTransportTests : EventObserverFunctionalityTests
{
    ...
    private sealed class TestEventTransportPublisher(
        ...
        Exception? exceptionToThrow = null) : IConquerorEventTransportPublisher<TestEventTransportAttribute>
    {
            ...
            where TEvent : class
        {
            ...
            Assert.That(configurationAttribute.Parameter, Is.EqualTo(evt is TestEventWithCustomTransport ? 10 : 20));
            ...
            {
                transportObservation.Attribute = configurationAttribute;
