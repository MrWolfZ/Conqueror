        ...
        string secondRegistrationMethod)
    {
        ...
        switch (firstLifetime, firstRegistrationMethod)
        {
            ...
            case (_, "instance"):
                ...
                break;
            case (_, "delegate"):
                Assert.That(services.Where(s => s.ServiceType == typeof(EventObserverDelegateRegistration)).ToList(), Has.Count.EqualTo(secondRegistrationMethod == "delegate" ? 2 : 1));
                break;
            default:
        ...
        switch (secondLifetime, secondRegistrationMethod)
        {
            ...
            case (_, "instance"):
                ...
                break;
            case (_, "delegate"):
                Assert.That(services.Where(s => s.ServiceType == typeof(EventObserverDelegateRegistration)).ToList(), Has.Count.EqualTo(firstRegistrationMethod == "delegate" ? 2 : 1));
                break;
            default:
