...
public sealed class EventObserverTransportTests
{
    ...
    private sealed class TestTransportReceiver(IServiceProvider serviceProvider, IEventTransportRegistry registry, IConquerorEventTransportReceiverBroadcaster broadcaster)
    {
