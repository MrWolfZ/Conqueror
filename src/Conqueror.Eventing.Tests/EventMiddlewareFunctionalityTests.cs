...
public sealed class EventMiddlewareFunctionalityTests
{
    ...
    [Test]
    public void GivenObserverWithPipelineConfigurationInterfaceWithoutPipelineConfigurationMethod_RegisteringObserverThrowsInvalidOperationException()
    {
        var services = new ServiceCollection();

        _ = Assert.Throws<InvalidOperationException>(() => services.AddConquerorEventObserver<TestEventObserverWithPipelineConfigurationInterfaceWithoutConfigurationMethod>());
    }

    [Test]
    public void GivenObserverWithPipelineConfigurationInterfaceWithInvalidPipelineConfigurationMethodReturnType_RegisteringObserverThrowsInvalidOperationException()
    {
        var services = new ServiceCollection();

        _ = Assert.Throws<InvalidOperationException>(() => services.AddConquerorEventObserver<TestEventObserverWithPipelineConfigurationInterfaceWithInvalidConfigurationMethodReturnType>());
    }

    [Test]
    public void GivenObserverWithPipelineConfigurationInterfaceWithInvalidPipelineConfigurationMethodParameters_RegisteringObserverThrowsInvalidOperationException()
    {
        var services = new ServiceCollection();

        _ = Assert.Throws<InvalidOperationException>(() => services.AddConquerorEventObserver<TestEventObserverWithPipelineConfigurationInterfaceWithInvalidConfigurationMethodParameters>());
    }
#endif
