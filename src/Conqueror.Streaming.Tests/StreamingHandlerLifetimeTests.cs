...
public sealed class StreamingHandlerLifetimeTests
{
    [Test]
    public async Task GivenTransientHandler_ResolvingHandlerCreatesNewInstanceEveryTime()
    {
        ...
        var handler1 = scope1.ServiceProvider.GetRequiredService<IStreamingHandler<TestStreaming, TestItem>>();
        var handler2 = scope1.ServiceProvider.GetRequiredService<IStreamingHandler<TestStreaming, TestItem>>();
        var handler3 = scope2.ServiceProvider.GetRequiredService<IStreamingHandler<TestStreaming, TestItem>>();
    ...
    public async Task GivenSingletonHandlerWithMultipleHandlerInterfaces_ResolvingHandlerViaEitherInterfaceReturnsSameInstanceEveryTime()
    {
        ...
        var handler1 = provider.GetRequiredService<IStreamingHandler<TestStreaming, TestItem>>();
        var handler2 = provider.GetRequiredService<IStreamingHandler<TestStreaming2, TestItem2>>();
    ...
    public async Task GivenSingletonHandler_ResolvingHandlerViaConcreteClassReturnsSameInstanceAsResolvingViaInterface()
    {
        ...
        var handler2 = provider.GetRequiredService<IStreamingHandler<TestStreaming, TestItem>>();
    ...
    private sealed class TestStreamingHandler : IStreamingHandler<TestStreaming, TestItem>
    {
    ...
    private sealed class TestStreamingHandlerWithMultipleInterfaces : IStreamingHandler<TestStreaming, TestItem>,
                                                                      IStreamingHandler<TestStreaming2, TestItem2>
    {
        private readonly TestObservations observations;
        private int invocationCount;
