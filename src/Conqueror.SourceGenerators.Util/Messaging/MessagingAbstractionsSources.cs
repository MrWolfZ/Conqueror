...
internal static class MessagingAbstractionsSources
{
    ...
    private static StringBuilder AppendGeneratedFile(this StringBuilder sb, in MessageTypesDescriptor descriptor)
    {
        ...
        return sb.AppendMessageExtensionsClass(indentation, in messageTypeDescriptor, in responseTypeDescriptor);
    }
}
