...
[Generator]
public sealed class HttpMessagingAbstractionsGenerator : IIncrementalGenerator
{
                                                                     ...
                                                                     SemanticModel semanticModel)
    {
        ...
        return new(MessagingAbstractionsGeneratorUtil.GenerateMessageTypesDescriptor(messageTypeSymbol, responseTypeSymbol, semanticModel),
                   httpMethod,
                   pathPrefix,
                   path,
                   fullPath,
