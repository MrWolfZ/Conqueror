...
{
    public static ReceiverExecutionHandle RunFileSystemMessageReceivers(
        this IMessageReceivers receivers,
    ...
    )
    {
        ...
        if (
            receivers.ServiceProvider.GetService(typeof(IFileSystemMessageReceivers))
            is not IFileSystemMessageReceivers fileSystemReceivers
        )
        {
    ...
    public static ReceiverExecutionHandle RunFileSystemMessageReceiver<THandler>(
        this IMessageReceivers receivers,
        CancellationToken cancellationToken
    )
