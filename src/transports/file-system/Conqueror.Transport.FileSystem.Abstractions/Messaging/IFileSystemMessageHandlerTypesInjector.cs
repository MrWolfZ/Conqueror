...
{
    void ConfigureFileSystemReceiver(IFileSystemMessageReceiver receiver);
    ...
    TResult Inject<TArg, TResult>(IFileSystemMessageTypesInjectable<TArg, TResult> injectable, TArg arg);
}
    ...
    where TIHandler : class, IFileSystemMessageHandler<TMessage, TResponse, TIHandler>
{
    ...
    public void ConfigureFileSystemReceiver(IFileSystemMessageReceiver receiver)
    {
