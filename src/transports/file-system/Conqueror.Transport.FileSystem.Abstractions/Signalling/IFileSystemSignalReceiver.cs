...
public interface IFileSystemSignalReceiver
{
    ...
    /// </summary>
    /// <param name="name">The name to identify this receiver for tracking which signals have already been processed</param>
    ...
    FileSystemSignalReceiverConfiguration EnableSingleInstance(string name, string baseDirectoryPath, TimeSpan pollingInterval);
