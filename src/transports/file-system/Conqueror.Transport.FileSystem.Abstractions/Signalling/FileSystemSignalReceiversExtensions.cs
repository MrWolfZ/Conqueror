...
{
    public static ReceiverExecutionHandle RunFileSystemSignalReceivers(
    ...
    )
    {
        ...
        if (
            receivers.ServiceProvider.GetService(typeof(IFileSystemSignalReceivers))
            is not IFileSystemSignalReceivers fileSystemReceivers
        )
        {
    ...
    public static ReceiverExecutionHandle RunFileSystemSignalReceiver<THandler>(
        this ISignalReceivers receivers,
        CancellationToken cancellationToken
    )
