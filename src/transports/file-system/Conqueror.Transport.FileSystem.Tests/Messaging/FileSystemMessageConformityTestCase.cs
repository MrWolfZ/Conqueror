...
public abstract class FileSystemMessageConformityTestCase
    : IMessageTransportConformityTestCase<FileSystemMessageTransportConformityTestHost>
{
    ...
    > SendMessages { get; init; }

    public required string Name { get; init; }

    public virtual FileSystemMessageTransportConformityTestHost CreateTestHost() =>
        FileSystemMessageTransportConformityTestHost.Create(this);

    Task<
        IReadOnlyCollection<object>
    > IMessageTransportConformityTestCase<FileSystemMessageTransportConformityTestHost>.SendMessages(
    ...
    public virtual void RegisterClientServices(IServiceCollection services) => RegisterOnSender?.Invoke(services);
