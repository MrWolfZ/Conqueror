...
internal sealed class FileSystemMessageSenderFactory(FileSystemStores fileSystemStores)
    : IFileSystemMessageSenderFactory
{
    public IFileSystemMessageSender<TMessage, TResponse> Create<TMessage, TResponse>(
