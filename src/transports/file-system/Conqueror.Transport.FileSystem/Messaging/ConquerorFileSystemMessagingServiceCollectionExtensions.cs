...
public static class ConquerorFileSystemMessagingServiceCollectionExtensions
{
    ...
    {
        var typesInjector = new FileSystemMessageHandlerTypesInjector<TMessage, TResponse, TIHandler>(configureReceiver);
    ...
    {
        var typesInjector = new FileSystemMessageHandlerTypesInjector<TMessage, UnitMessageResponse, TIHandler>(configureReceiver);
