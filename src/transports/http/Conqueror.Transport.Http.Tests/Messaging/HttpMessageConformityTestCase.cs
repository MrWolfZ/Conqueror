...
public abstract class HttpMessageConformityTestCase
    : IMessageTransportConformityTestCase<HttpMessageTransportConformityTestHost>
{
    ...
    public virtual HttpMessageTransportConformityTestHost CreateTestHost() =>
        HttpMessageTransportConformityTestHost.Create(this);

    Task<
        IReadOnlyCollection<object>
    > IMessageTransportConformityTestCase<HttpMessageTransportConformityTestHost>.SendMessages(
    ...
    public virtual void RegisterClientServices(IServiceCollection services) => RegisterOnClient?.Invoke(services);
