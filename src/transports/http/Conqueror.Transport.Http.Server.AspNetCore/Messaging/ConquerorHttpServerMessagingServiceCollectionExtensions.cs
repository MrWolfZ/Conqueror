...
public static class ConquerorHttpServerMessagingServiceCollectionExtensions
{
    ...
    {
        var typesInjector = new HttpMessageHandlerTypesInjector<TMessage, TResponse, TIHandler>(
    ...
    {
        var typesInjector = new HttpMessageHandlerTypesInjector<TMessage, UnitMessageResponse, TIHandler>(
            configureReceiver: null
        );
