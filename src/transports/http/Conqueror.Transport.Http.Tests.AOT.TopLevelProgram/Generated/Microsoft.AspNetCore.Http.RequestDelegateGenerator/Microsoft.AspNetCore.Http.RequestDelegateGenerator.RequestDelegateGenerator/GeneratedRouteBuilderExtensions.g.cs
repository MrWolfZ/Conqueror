    ...
    file static class GeneratedRouteBuilderExtensionsCore
    {
            ...
            Delegate handler)
        {
            ...
            RequestDelegateFactoryFunc createRequestDelegate = (del, options, inferredMetadataResult) =>
            {
                ...
                var handler = Cast(del, global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Http.IResult> (global::Microsoft.AspNetCore.Http.HttpContext arg0) => throw null!);
                ...
                if (options.EndpointBuilder.FilterFactories.Count > 0)
                {
                    filteredInvocation = GeneratedRouteBuilderExtensionsCore.BuildFilterDelegate(async ic =>
                    {
                        ...
                        var task = handler(ic.GetArgument<global::Microsoft.AspNetCore.Http.HttpContext>(0)!);
                ...
                async Task RequestHandlerFiltered(HttpContext httpContext)
                {
                    ...
                    var result = await filteredInvocation(EndpointFilterInvocationContext.Create<global::Microsoft.AspNetCore.Http.HttpContext>(httpContext, ctx_local));
            ...
            Delegate handler)
        {
            ...
            RequestDelegateFactoryFunc createRequestDelegate = (del, options, inferredMetadataResult) =>
            {
                ...
                Debug.Assert(options.EndpointBuilder.ApplicationServices != null, "ApplicationServices not found.");
                Debug.Assert(options.EndpointBuilder.FilterFactories != null, "FilterFactories not found.");
                var handler = Cast(del, global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Http.IResult> (global::System.Int32 arg0, global::Microsoft.AspNetCore.Http.HttpContext arg1) => throw null!);
                EndpointFilterDelegate? filteredInvocation = null;
                var serviceProvider = options.ServiceProvider ?? options.EndpointBuilder.ApplicationServices;
                ...
                jsonSerializerOptions.MakeReadOnly();
                var objectJsonTypeInfo = (JsonTypeInfo<object?>)jsonSerializerOptions.GetTypeInfo(typeof(object));
                var payload_RouteOrQueryResolver = GeneratedRouteBuilderExtensionsCore.ResolveFromRouteOrQuery("payload", options.RouteParameterNames);
                ...
                if (options.EndpointBuilder.FilterFactories.Count > 0)
                {
                    filteredInvocation = GeneratedRouteBuilderExtensionsCore.BuildFilterDelegate(async ic =>
                    {
                        ...
                        var task = handler(ic.GetArgument<global::System.Int32>(0)!, ic.GetArgument<global::Microsoft.AspNetCore.Http.HttpContext>(1)!);
                        var result = await task;
                        return (object?)result;
                    },
                    options.EndpointBuilder,
                ...
                {
                    var wasParamCheckFailure = false;
                                        // Endpoint Parameter: payload (Type = int, IsOptional = False, IsParsable = True, IsArray = False, Source = RouteOrQuery)
                    var payload_raw = payload_RouteOrQueryResolver(httpContext);
                    if (payload_raw is StringValues { Count: 0 })
                    {
                        wasParamCheckFailure = true;
                        logOrThrowExceptionHelper.RequiredParameterNotProvided("int", "payload", "route or query string");
                    }
                    var payload_temp = (string?)payload_raw;
                    if (!GeneratedRouteBuilderExtensionsCore.TryParseExplicit<int>(payload_temp!, CultureInfo.InvariantCulture, out var payload_parsed_temp))
                    {
                        if (!string.IsNullOrEmpty(payload_temp))
                        {
                            logOrThrowExceptionHelper.ParameterBindingFailed("int", "payload", payload_temp);
                            wasParamCheckFailure = true;
                        }
                    }
                    int payload_local = payload_parsed_temp!;
                    var ctx_local = httpContext;
                    ...
                    var task = handler(payload_local!, ctx_local);
                    var result = await task;
                    if (result == null)
                    {
                        throw new InvalidOperationException("The IResult returned by the Delegate must not be null.");
                ...
                async Task RequestHandlerFiltered(HttpContext httpContext)
                {
                    ...
                    var result = await filteredInvocation(EndpointFilterInvocationContext.Create<global::System.Int32, global::Microsoft.AspNetCore.Http.HttpContext>(httpContext, payload_local!, ctx_local));
                    if (result is not null)
                    {
                        await GeneratedRouteBuilderExtensionsCore.ExecuteReturnAsync(result, httpContext, objectJsonTypeInfo);
                    }
