...
{
    static virtual string EventType { get; } =
    ...
    internal static virtual IHttpSseSignalSerializer<TSignal> HttpSseSignalSerializer { get; } =
        new HttpSseSignalJsonSerializer<TSignal>();
