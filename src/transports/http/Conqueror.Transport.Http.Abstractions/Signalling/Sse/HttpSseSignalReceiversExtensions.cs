...
{
    public static ReceiverExecutionHandle RunHttpSseSignalReceivers(
    ...
    )
    {
        ...
        if (
            receivers.ServiceProvider.GetService(typeof(IHttpSseSignalReceivers))
            is not IHttpSseSignalReceivers httpReceivers
        )
        {
    ...
    public static ReceiverExecutionHandle RunHttpSseSignalReceiver<THandler>(
        this ISignalReceivers receivers,
        CancellationToken cancellationToken
    )
