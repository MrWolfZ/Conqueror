...
internal static class HttpJsonSerializerOptions
{
    [UnconditionalSuppressMessage(
        ...
        Justification =
            "In AOT contexts we are fine with failing to deserialize the response, since there will be a clear error message telling them what needs to be done, and the failure will be found immediately when executing the message"
    )]
    [UnconditionalSuppressMessage(
        "Aot",
