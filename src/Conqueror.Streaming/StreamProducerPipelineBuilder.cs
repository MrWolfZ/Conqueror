...
) : IStreamProducerPipelineBuilder
{
    private readonly List<(
        ...
        IStreamProducerMiddlewareInvoker Invoker
    )> middlewares = [];
    ...
    public IStreamProducerPipelineBuilder Configure<TMiddleware, TConfiguration>(Action<TConfiguration> configureFn)
        where TMiddleware : IStreamProducerMiddleware<TConfiguration>
    {
    ...
    public IStreamProducerPipelineBuilder Configure<TMiddleware, TConfiguration>(
    ...
    public StreamProducerPipeline Build(ConquerorContext conquerorContext) => new(conquerorContext, middlewares);
