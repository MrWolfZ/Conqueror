...
public static class ConquerorContextStreamingExtensions
{
    ...
    public static string? GetStreamingRequestId(this IConquerorContext conquerorContext)
    {
    ...
    public static void SetStreamingRequestId(this IConquerorContext conquerorContext, string streamingRequestId)
    {
