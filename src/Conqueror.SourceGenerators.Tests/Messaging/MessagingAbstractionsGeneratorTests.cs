...
[TestFixture]
public sealed class MessagingAbstractionsGeneratorTests
{
    private readonly IReadOnlyCollection<IIncrementalGenerator> generators = [new MessagingAbstractionsGenerator()];
...
partial class Container
{
    ...
    private static VerifySettings Settings()
    {
        ...
        settings.UseTypeName(nameof(MessagingAbstractionsGeneratorTests));
