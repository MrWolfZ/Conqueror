...
{
    public Task Handle(TestMessage<TFirst, TSecond> message, CancellationToken cancellationToken) =>
        throw new NotSupportedException();
}

public partial class TestMessageHandler : TestMessage<string, int>.IHandler
{
    public Task Handle(TestMessage<string, int> message, CancellationToken cancellationToken) =>
        throw new NotSupportedException();
}
