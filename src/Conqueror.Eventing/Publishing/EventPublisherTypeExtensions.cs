...
internal static class EventPublisherTypeExtensions
{
    ...
    private static bool IsEventPublisherInterfaceType(this Type t) => t is { IsInterface: true, IsGenericType: true } && t.GetGenericTypeDefinition() == typeof(IConquerorEventTransportPublisher<>);
}
