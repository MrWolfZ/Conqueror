...
public static class ConquerorEventingTransportPublisherServiceCollectionExtensions
{
                                                                          ...
                                                                          Type publisherType)
    {
        ...
        foreach (var configurationAttributeType in publisherType.GetPublisherConfigurationAttributeTypes())
        {
            var registration = new EventTransportPublisherRegistration(publisherType, configurationAttributeType);
