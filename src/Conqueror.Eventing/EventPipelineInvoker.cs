...
internal static class EventPipelineInvoker
{
        ...
        where TObservedEvent : class
    {
        ...
        var transportTypeName = configurationAttribute.TransportTypeName;
        ...
        return pipeline.Execute(serviceProvider, observerFn, evt, observedEventType, transportType, cancellationToken);
    }
}
